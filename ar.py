...
<style>
.stApp {
  background: linear-gradient(to bottom,#0b014a, #001626);
...
@media print {
  ...
  body {
    background: linear-gradient(to bottom, #0b014a, #001626) !important;
    height: 100vh;
    margin: 0;
    padding: 0;
  }
...
[data-testid="stHeader"] {
  background: linear-gradient(to top, #0b014a, #001626) !important;
}
