...
<style>
.stApp {
  background: linear-gradient(to bottom,#041c2e, #031827);
...
@media print {
  ...
  body {
    background: linear-gradient(to bottom, #041c2e, #031827) !important;
    height: 100vh;
    margin: 0;
    padding: 0;
  }
...
[data-testid="stHeader"] {
  background: linear-gradient(to top, #041c2e, #035996) !important;
}
